...
/**
 * Disclaimer item class for displaying emergency call limitation UI on {@link DisclaimerActivity}.
 */
class EmergencyCallLimitationDisclaimer extends DisclaimerItem {
    ...
    EmergencyCallLimitationDisclaimer(Context context, int phoneId) {
    ...
    @Override
    boolean shouldShow() {
        int notificationDelay = getCarrierConfig().getInt(
    ...
    protected int getMessageId() {
        return R.string.wfc_disclaimer_emergency_limitation_desc_txt;
    }
